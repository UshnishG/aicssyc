...
export function Contact() {
  return (
    <section id="contact" className="relative py-24 md:py-32 bg-ivory">
      <div className="container-editorial">
        <div className="grid lg:grid-cols-[1fr_1.1fr] gap-12 lg:gap-20 items-start">
          <div>
            ...
            <h2 className="mt-6 font-display text-4xl md:text-5xl leading-[1.05] tracking-tight text-midnight text-balance">
              Questions about the congress? <em className="italic font-normal text-emerald">Reach out.</em>
            </h2>
            <p className="mt-6 text-midnight/70 max-w-md leading-relaxed">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <a
              ...
              className="group block bg-ivory border border-midnight/15 p-8 transition hover:border-emerald"
            >
              <Instagram size={22} className="text-emerald" />
              <p className="mt-6 text-xs uppercase tracking-[0.22em] text-emerald">Instagram</p>
              <p className="mt-2 font-display text-lg text-midnight">
                @ieeecs_srmist
              </p>
              <p className="mt-4 text-sm text-midnight/60 inline-flex items-center gap-2">
                Follow updates
                <span className="transition-transform group-hover:translate-x-1">→</span>
              </p>
            </a>
