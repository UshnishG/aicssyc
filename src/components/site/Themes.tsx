...
const themes = [
  {
    ...
    blurb: "From foundation models to embodied agents — what shipped, what failed, what's next.",
    topics: ["Reasoning systems", "Multi-agent orchestration", "On-device inference", "Evaluations"],
    outcomes: ["Working production patterns", "Benchmarks released live", "Hiring research collaborators"],
    speakers: "12 keynotes · 34 sessions",
  },
  {
    icon: Zap,
    title: "Energy & compute",
    blurb: "The physical substrate of the next decade — silicon, power, cooling, and the grid.",
    topics: ["Datacenter design", "Photonic interconnect", "Grid-scale storage", "SMR & nuclear"],
    outcomes: ["RFP-ready architectures", "PPA frameworks", "Capacity planning models"],
    speakers: "8 keynotes · 22 sessions",
  },
  {
    icon: ShieldCheck,
    title: "Trust, safety & policy",
    blurb: "Where the engineering meets governance — and how to ship under it.",
    topics: ["AI Act compliance", "Red-teaming", "Cryptographic provenance", "Critical-systems certification"],
    outcomes: ["Compliance playbooks", "Direct regulator Q&A", "Open standards drafts"],
    speakers: "9 keynotes · 28 sessions",
  },
  {
    icon: Atom,
    title: "Quantum & post-classical",
    blurb: "The systems that are no longer theoretical — and the migration window we're already in.",
    topics: ["Error-corrected qubits", "Post-quantum cryptography", "Hybrid algorithms", "Industrial use cases"],
    outcomes: ["Migration roadmaps", "Vendor comparison", "Pilot partner intros"],
    speakers: "6 keynotes · 18 sessions",
  },
  {
    icon: Network,
    title: "Resilient infrastructure",
    blurb: "Distributed systems for a world where reliability is a competitive moat.",
    topics: ["Edge architectures", "Sovereign cloud", "Disaster recovery at scale", "SRE at GW-scale"],
    outcomes: ["Reference architectures", "Vendor-neutral SLOs", "Multi-region playbooks"],
    speakers: "7 keynotes · 24 sessions",
  },
  {
    icon: Globe2,
    title: "Climate & planetary systems",
    blurb: "Where technology is doing measurable work on the largest problem we have.",
    topics: ["Carbon removal at scale", "Earth observation", "Materials discovery", "Climate ML"],
    outcomes: ["Funded pilot partners", "Open datasets", "Cross-sector working groups"],
    speakers: "5 keynotes · 19 sessions",
  },
];
